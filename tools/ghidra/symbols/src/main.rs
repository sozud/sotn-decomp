...
fn parse_with_lang_c(file_path: &String) -> Vec<MyFunc>  {
    ...
    // config.cpp_command = "cpp /home/d/sotn-decomp/src/saturn/zero.h".to_string();
...
// fn test_empty() {
//     let mut config = Config::default();
//     let parsed = parse_with_lang_c(&"/home/d/sotn-decomp/tools/ghidra/symbols/test/empty.c".to_string());
// }

// #[test]
// fn test_pointer_args() {
//     let mut config = Config::default();
//     let parsed = parse_with_lang_c(&"/home/d/sotn-decomp/tools/ghidra/symbols/test/pointer_args.c".to_string());
// }
...
//     let filename = "/home/d/sotn-decomp/build/saturn/zero.map";
...
fn main() {
    ...
    let mut config = Config::default();
    config.cpp_options.push("-DPERMUTER".to_string());
    // let parsed = parse(&config, "example.c");
    let parsed = parse_with_lang_c(&"/home/d/sotn-decomp/src/saturn/zero.c".to_string());
    ...
    let file_path = "/home/d/sotn-decomp/symbols.json";
