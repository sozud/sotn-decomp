...
s32 SpuSetReverb(s32 on_off) {
    ...
    case 0:
        _spu_rev_flag = 0;
#ifdef VERSION_PC
        var_v1 = read_16(0x1AA, __FILE__, __LINE__); // spucnt
        var_v1 = var_v1 & 0xFF7F;
        write_16(0x1AA, var_v1); // spucnt
#else
    ...
    case 1:
        if ((_spu_rev_reserve_wa != on_off) &&
            ...
            _spu_rev_flag = 0;
#ifdef VERSION_PC
            var_v1 = read_16(0x1AA, __FILE__, __LINE__);
            var_v1 = var_v1 & 0xFF7F;
            new_var = var_v1;
            write_16(0x1AA, new_var);
#else
            var_v1 = _spu_RXX->rxxnv.spucnt;
            var_v1 = var_v1 & 0xFF7F;
            new_var = var_v1;
...
#ifdef VERSION_PC
            var_v1 = (new_var = read_16(0x1AA, __FILE__, __LINE__)) | 0x80;
            write_16(0x1AA, var_v1);
#else
