...
u32 _SpuMallocSeparateTo3(s32 arg0, SPU_MALLOC* arg1, s32 arg2) {
    ...
    if (var_a3 >= temp_size) {
        if (temp_t3 & 0x40000000) {
            ...
            D_80033560++;
            fmask = 0x0FFFFFFF;
            _spu_memList[D_80033560].addr = ((temp_t3 & fmask) + temp_t1 + temp_size);
            fourmask = 0x40000000;
            ...
            if (var_v0_2 >= D_80033560) {
                ...
                if (var_a3 >= temp_size) {
                    ...
                    var_v1_2->addr = ((temp_t3 & 0x0FFFFFFF) + temp_t1 + temp_size) | 0x80000000;
        ...
        } else if ((temp_size >= var_a3) || (var_v0 = (SPU_MALLOC* )-1, (((D_8003355C - 1) < D_80033560) == 0))) {
            ...
            if (temp_size < var_a3) {
                ...
                _spu_memList[D_80033560].addr = ((temp_t3 & 0x0FFFFFFF) + temp_size) | 0x80000000;
