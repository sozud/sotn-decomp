...
// DATA SECTION START
static u32 D_80186EC0[] = {0x10101504, 0x0000FF10};
static u32 D_80186EC8[] = {0x10101204, 0x0000FF10};
static u32 D_80186ED0[] = {0x10101104, 0x0000FF10};
static u32 D_80186ED8[] = {0x10101704, 0x000000FF};
static u32 D_80186EE0[] = {0x10101404, 0x000000FF};
static u32 D_80186EE8[] = {0x10151204, 0x000000FF};
static u32 D_80186EF0[] = {0x10101104, 0x000000FF};
static u32 D_80186EF8[] = {0xFF101504, 0x00000000};
static u32 D_80186F00[] = {0xFF151204, 0x00000000};
static u32 D_80186F08[] = {0x00FF1104, 0x00000000};

// DATA SECTION END

// BSS SECTION START
static s32 D_80193AA0 = 0;
static s32 D_80193AA4 = 0;
static s32 D_80193AA8 = 0;
static s32 D_80193AAC = 0;
static u16* g_LayoutObjHorizontal = NULL;
static u16* g_LayoutObjVertical = NULL;
static u8 g_LayoutObjPosHorizontal = 0;
static u8 g_LayoutObjPosVertical = 0;
// static u16 g_ItemIconSlots[32] = {0};
// BSS SECTION END
...
void InitStageNz0(Overlay* o) {
    ...
    g_StageDesc.tileLayers = LoadRoomsLayers("assets/st/nz0/rooms.layers.json");
    g_StageDesc.rooms = LoadRoomDefs("assets/st/nz0/g_Rooms.roomdef.json");
