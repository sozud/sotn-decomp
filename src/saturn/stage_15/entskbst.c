...
u8 g_Stage15SkeletonBeastIdleAnim[14] = {
    6, 1, 4, 1, 4, 2, 6, 3, 5, 4, 5, 5, 0xFF, 0xFF,
};
u8 g_Stage15SkeletonBeastWalkAnim[14] = {
    6, 1, 4, 2, 4, 3, 6, 4, 5, 5, 5, 6, 0xFF, 0xFF,
};
u8 g_Stage15SkeletonBeastWalkBackAnim[14] = {
    6, 1, 5, 6, 5, 5, 6, 4, 4, 3, 4, 2, 0xFF, 0xFF,
};
u8 g_Stage15SkeletonBeastAttackAnim[14] = {
    5, 7, 6, 8, 5, 9, 5, 0xA, 5, 0xB, 5, 0xC, 0xFF, 0xFF,
};
u8 g_Stage15SkeletonBeastJumpAnim[10] = {
    1, 1, 4, 0xD, 4, 0xE, 1, 1, 0xFF, 0xFF,
};
u8 g_Stage15SkeletonBeastLandAnim[12] = {
