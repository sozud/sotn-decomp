...
EntityEntry g_Stage15EntityEntry54 = {
    &g_Stage15SpriteBank28, func_060ED1C0};
s16 g_Stage15VenusManTrapFlowerInitOffset[2] = {0, 0};
EntityEntry g_Stage15EntityEntry56 = {
    &g_Stage15SpriteBank28, func_060ED848};
s16 g_Stage15VenusManTrapTendrilInitOffset[2] = {0, 0};
EntityEntry g_Stage15EntityEntry57 = {
    &g_Stage15SpriteBank28, func_060EDA88};
s16 g_Stage15VenusManTrapDartInitOffset[2] = {0, 0};
EntityEntry g_Stage15EntityEntry55 = {
    &g_Stage15SpriteBank28, func_060EDD10};
...
u8* g_Stage15VenusManTrapAnimations[] = {
    g_Stage15VenusManTrapAnimation0,
    g_Stage15VenusManTrapAnimation1,
    g_Stage15VenusManTrapAnimation2,
    g_Stage15VenusManTrapAnimation3,
    g_Stage15VenusManTrapAnimation4,
    g_Stage15VenusManTrapAnimation5,
