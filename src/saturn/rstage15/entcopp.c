...
EntityEntry g_RStage15EntityEntry52 = {
    &g_RStage15SpriteBank27, func_060EAE6C};
s16 g_RStage15CopperArmorWeaponInitOffset[2] = {0, 28};

EntityEntry g_RStage15EntityEntry54 = {
    &g_RStage15SpriteBank27, func_060EAFF8};
s16 g_RStage15CopperArmorShieldInitOffset[2] = {0, 28};

EntityEntry g_RStage15EntityEntry53 = {
    &g_RStage15SpriteBank27, func_060EB150};
