...
EntityEntry g_Stage16EntityGargoyle = {
    &g_Stage16SpriteBank24, func_060E63A8};
...
EntityEntry g_Stage16EntityEntry33 = {
    &g_Stage16SpriteBank24, func_060E6A6C};
s32 g_Stage16GargoyleAttackEntityParams[2] = {2, 0};

EntityEntry g_Stage16EntityEntry34 = {
    &g_Stage16SpriteBank24, func_060E6C88};

u8 g_Stage16GargoyleIdleAnim[8] = {
    0x62, 1, 0x62, 0x3A, 0x62, 0x3B, 0xFF, 0xFF,
};
u8 g_Stage16GargoyleWakeAnim[38] = {
    3, 2, 1, 3, 1, 2, 1, 3, 1, 4, 1, 3, 0x2B, 4, 6, 5, 6, 6, 6,
    7, 6, 8, 0x29, 4, 7, 9, 0x1A, 0xA, 2, 0xB, 3, 0xC, 3, 0xD,
    4, 0xE, 0xFF, 0xFF,
};
u8 g_Stage16GargoyleAttackAnim[12] = {
    6, 0x10, 4, 0x11, 7, 0x12, 2, 0x13, 5, 0x14, 0, 0,
};
u8 g_Stage16GargoyleRecoverAnim[22] = {
    0xB, 0x15, 0x13, 0x16, 2, 0x17, 2, 0x18, 5, 0x19, 0xB,
    0x1A, 9, 0x1B, 7, 0x1C, 8, 0x1D, 0xA, 0x1E, 0xFF, 0xFF,
};
u8 g_Stage16GargoyleDeathAnim[22] = {
...
u8* g_Stage16GargoyleAnimations[] = {
    g_Stage16GargoyleIdleAnim,
    g_Stage16GargoyleWakeAnim,
    g_Stage16GargoyleAttackAnim,
    g_Stage16GargoyleRecoverAnim,
    g_Stage16GargoyleDeathAnim,
};
