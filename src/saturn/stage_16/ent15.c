...
EntityEntry g_Stage16EntityEntry15 = {
    &g_EntitySpriteBank14, func_060E1928};

s16 g_Stage16Entity15CollisionSensors[8][2] = {
    {0, 16}, {0, 4}, {8, -4}, {-16, 0},
    {0, 16}, {12, 0}, {-12, 16}, {0, -16},
};
...
u8 g_Stage16Entity15Animation3[44] = {
    0x20, 1, 1, 2, 1, 3, 1, 4, 0x11, 5, 0x1C, 6,
    1, 7, 1, 8, 1, 7, 1, 8, 1, 7, 2, 8,
    2, 7, 3, 8, 0x20, 7, 8, 9, 0xC, 0xA, 7, 5,
    4, 4, 4, 3, 0x10, 2, 0xFF, 0,
};
...
u8 g_Stage16Entity15Animation6[44] = {
    0x10, 1, 1, 2, 1, 3, 1, 4, 0x10, 5, 0x1C, 6,
    1, 7, 1, 8, 1, 7, 1, 8, 1, 7, 2, 8,
    2, 7, 3, 8, 0x20, 7, 8, 9, 0xC, 0xA, 7, 5,
    4, 4, 4, 3, 0x10, 2, 0xFF, 0,
};
u8 g_Stage16Entity15Animation7[42] = {
    ...
    1, 0x25, 1, 0x26, 1, 0x25, 1, 0x26, 1, 0x25,
    2, 0x26, 2, 0x25, 3, 0x26, 0x20, 0x25, 8, 0x27,
    0xC, 0x28, 3, 0x23, 3, 0x22, 3, 0x21, 0x10, 0xB, 0xFF, 0,
};
...
s32 g_Stage16Entity15PartVelocityX[8] = {
    0x0000C000, 0x0001C000, 0x0001C000, 0x00018000,
    0x00020000, 0x00010000, 0x0000C000, 0x00018000,
};
